...
class ImagePanel extends JPanel
{
	...
	class ImageListSelectionListener implements ListSelectionListener
	{
		...
		{
			m_ImageLabel.setIcon(((IMyImage)m_ListModel.getElementAt(m_ImageList.getSelectedIndex())).getImage());
		}
	};
	...
	public static void main(String args[])
	{
		try
		{
			...
			JFrame frame = new JFrame("Image Browser Version 2.0 - Loading time = " + (lEnd - lStart) + "ms");
